            ...
            @csrf
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Enter your Phone" class="form-control" name="phone" value="{{$fellow->phone}}"/><br />
                    </div>
                        <div class="form-group">
                            <label>Email:</label>
                            <input type="email" placeholder="Email Address" class="form-control" name="email" value="{{$fellow->email}}"/><br />
                        </div>
                            <div class="form-group form-check form-check-inline">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  class="form-control"type="text" placeholder="Qualification" name="qualification" value="{{$fellow->qualification}}" />
                                    <br />
                                </div>
            <div class="form-group">
            <label>Your choice:</label>
            <select class="form-control"name="choice" value="{{$fellow->choice}}">
